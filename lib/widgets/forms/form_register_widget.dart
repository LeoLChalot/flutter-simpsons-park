...
class FormRegisterWidge extends StatefulWidget {
  ...
  const FormRegisterWidge({super.key, required this.onSwitchToLogin});

  @override
  State<FormRegisterWidge> createState() => _FormRegisterWidgeState();
}

class _FormRegisterWidgeState extends State<FormRegisterWidge> {
